...
//            new ProductValue('mapped_properties.productname', 'text', $rawMappedProduct['weight'] ?? null),
        ];

        return new Product($productUuid, $label, $rawMappedProduct['body_html'], $values);
    }
}
